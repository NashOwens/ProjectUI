...
public abstract class AdminMenu extends JFrame implements ActionListener {
    ...
    public static JFrame createGUI(JFrame menuWindow) {
        ...
        deleteProduct.addActionListener(e -> {
            if (e.getSource() == deleteProduct) {
                try {
                    DeleteProduct.productDelSelc(removeAll(menuWindow, deleteProduct, addProduct, editProduct, searchProduct, viewProduct, logOut));
                } catch (Exception ex) {
        ...
        addProduct.addActionListener(e -> {
            if (e.getSource() == addProduct) {
                try {
                    AddProduct.createGUI(removeAll(menuWindow, deleteProduct, addProduct, editProduct, searchProduct, viewProduct, logOut));
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(null, ex.toString());
                }
            }
        ...
        editProduct.addActionListener(e -> {
            if (e.getSource() == editProduct) {
                try {
                    EditProduct.createGUI(removeAll(menuWindow, deleteProduct, addProduct, editProduct, searchProduct, viewProduct, logOut));
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(null, ex.toString());
                }
            }
        ...
        viewProduct.addActionListener(e -> {
            if (e.getSource() == viewProduct) {
                try {
                    ViewProducts.createGUI(removeAll(menuWindow, deleteProduct, addProduct, editProduct, searchProduct, viewProduct, logOut));
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(null, ex.toString());
                }
            }
        ...
        searchProduct.addActionListener(e -> {
            if (e.getSource() == searchProduct) {
                try {
                    SearchProduct.createGUI(removeAll(menuWindow, deleteProduct, addProduct, editProduct, searchProduct, viewProduct, logOut));
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(null, ex.toString());
                }
            }
    ...
    private static JFrame removeAll(JFrame menuWindow, JButton deleteProduct, JButton addProduct, JButton editProduct, JButton searchProduct, JButton viewProduct, JButton logOut){
